<?php
class Matheus_AssignToGrouped_IndexController extends Mage_Adminhtml_Controller_Action
{
	public function indexAction() 
	{
		$url = $this->getUrl('assign_grouped/start/index');
		...
		$block = $this->getLayout()
		    ->createBlock('core/text', 'grouped-block')
